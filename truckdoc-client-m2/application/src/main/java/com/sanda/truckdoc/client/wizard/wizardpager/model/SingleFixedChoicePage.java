...
import com.sanda.truckdoc.client.wizard.wizardpager.ui.SingleChoiceFragment;
...
public class SingleFixedChoicePage extends Page {
    ...
    public void getReviewItems(ArrayList<ReviewItem> dest) {
        dest.add(new ReviewItem(getTitle(), mData.getString(SIMPLE_DATA_KEY), getKey(), true));
    }
