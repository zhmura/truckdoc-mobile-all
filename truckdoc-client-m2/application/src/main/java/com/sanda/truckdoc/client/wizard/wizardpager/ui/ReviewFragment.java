...
public class ReviewFragment extends ListFragment implements ModelCallbacks {
    ...
    public void onPageDataChanged(Page changedPage) {
        ...
        Collections.sort(reviewItems, (a, b) -> a.getWeight() > b.getWeight() ? +1 : a.getWeight() < b.getWeight() ? -1 : 0);
    ...
    private class ReviewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup container) {
            ...
            View rootView = inflater.inflate(R.layout.listitem_review, container, false);
